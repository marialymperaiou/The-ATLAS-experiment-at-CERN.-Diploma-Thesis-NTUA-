ATLAS detector simulation. Inner detector sybsystems.
...
c     *********************************************************************** 
c    The Inner Detector (ID) is designed around the beampipe regions.  
c    --- Beampipe ---                                                           
...
sp2     1 1                                                                     
c     ***********************************************************************   
c                     Tallies. F4 tallies (flux in cells)                                                   
c     *********************************************************************** 
c     Cell flux tallies are placed in regions of the Inner Detector, as in
c     the case of the beampipe. Photon fluxes in those cells are measured.  
f14:p 2                                                                         
f24:p 5                                                                         
f34:p 6                                                                         
f44:p 9                                                                         
