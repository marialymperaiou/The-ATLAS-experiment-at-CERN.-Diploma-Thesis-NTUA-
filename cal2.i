...
sp2     1 1                                                                     
c     ***********************************************************************   
c                     Tallies. F2 tallies (flux on surfaces)                                                   
c     ***********************************************************************
c     Surface tallies are placed on critical surfaces of the ATLAS inner 
c     detector and calorimeter regions, which are indicated below. Surface
c     fluxes are measured on those surfaces.
c        
f12:p 20.1 $Pixel                                                               
