ATLAS detector simulation. Design of the beampipe regions
c     Created on: Saturday, November 05, 2016 at 10:44                          
    ...
    17     4   -8.96 -17 15 
    18     4   -8.96 -18 16 
    100   0       2 5 6 9 10 13 14 17 18

c     ***********************************************************************   
c    Detector Subsystems. Beampipe regions                                                        
c     ***********************************************************************   
c    --- Beampipe ---                                                           
...
c     *********************************************************************** 
c     Materials that are used in the ATLAS beampipe
c       
...
imp:p             1 17r                      0  $ 1, 100
c     ***********************************************************************   
c                    Source Specification. Placed at the origin
c                    emits 2 photons of 10 MeV energy each                                       
c     *********************************************************************** 
c     Various alternatives of the source may be implemented. Trials with
c     other point sources, other emmited particles, cylindrical and
c     volume sources.
c       
...
c     *********************************************************************** 
c      In this section tallies are placed in some cells of the represented
c      geometry (ATLAS beampipe) in order to obtain meaningful results
c      regarding the photon fluxes in those cells.
c        
f14:p 2                                                                         
f24:p 5                                                                         
f34:p 6    
...
c                           Energy Bins (MeV)                                   
c     ***********************************************************************  
c      In this section the energy spectrum of the particles that will occur
c      after any interactions is fully covered.
c
...
c     *********************************************************************** 
c     Simulation running time. 1 minute gives us a general overview
c     of the output. Any precise final simulation should be left
c     running for 24 hours. Thus, the statistical errors decrease
c     dramatically.   
ctme 1                                                                          
